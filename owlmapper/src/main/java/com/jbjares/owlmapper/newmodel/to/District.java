 ...
 * Source Class: District <br>
 * @version generated on Sun Jan 11 02:43:59 GMT 2015 by jbjares
 */

public interface District extends Place {
    ...
    /* ***************************************************
     * Property http://www.IRLontologies.ie/personOntology.owl#OWLObjectPropertyImpl_01420721646876718000
     */
     
    /**
     * Gets all property values for the is_district_of property.<p>
     * 
     * @returns a collection of values for the is_district_of property.
     */
    Collection<? extends Person> getIs_district_of();

    /**
     * Checks if the class has a is_district_of property value.<p>
     * 
     * @return true if there is a is_district_of property value.
     */
    boolean hasIs_district_of();

    /**
     * Adds a is_district_of property value.<p>
     * 
     * @param newIs_district_of the is_district_of property value to be added
     */
    void addIs_district_of(Person newIs_district_of);

    /**
     * Removes a is_district_of property value.<p>
     * 
     * @param oldIs_district_of the is_district_of property value to be removed.
     */
    void removeIs_district_of(Person oldIs_district_of);
