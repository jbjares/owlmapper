 ...
 * Source Class: Death_event <br>
 * @version generated on Sun Jan 11 02:43:59 GMT 2015 by jbjares
 */

public interface Death_event extends Event {

    /* ***************************************************
     * Property http://www.IRLontologies.ie/historicalEvents.owl#deathRecordOf
     */
     
    /**
     * Gets all property values for the death_record_of property.<p>
     * 
     * @returns a collection of values for the death_record_of property.
     */
    Collection<? extends Person> getDeath_record_of();

    /**
     * Checks if the class has a death_record_of property value.<p>
     * 
     * @return true if there is a death_record_of property value.
     */
    boolean hasDeath_record_of();

    /**
     * Adds a death_record_of property value.<p>
     * 
     * @param newDeath_record_of the death_record_of property value to be added
     */
    void addDeath_record_of(Person newDeath_record_of);

    /**
     * Removes a death_record_of property value.<p>
     * 
     * @param oldDeath_record_of the death_record_of property value to be removed.
     */
    void removeDeath_record_of(Person oldDeath_record_of);
